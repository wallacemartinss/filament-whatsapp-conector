 ...
 * @method static array sendButtons(string|int $instanceId, string $number, string $description, array $buttons, ?string $title = null, ?string $footer = null, array $options = [])
 * @method static array sendCta(string|int $instanceId, string $number, string $description, array $buttons, ?string $title = null, ?string $footer = null, array $options = [])
 * @method static array sendPix(string|int $instanceId, string $number, string $description, array $pix, ?string $title = null, ?string $footer = null, array $options = [])
 * @method static array sendList(string|int $instanceId, string $number, string $title, string $description, string $buttonText, array $sections, ?string $footerText = null, array $options = [])
 * @method static array sendCarousel(string|int $instanceId, string $number, string $message, array $cards, array $options = [])
