...
return [
    ...
    'actions' => [
        ...
        'delete' => 'Видалити',
        'delete_confirmation' => 'Ця дія перемістить екземпляр до кошика. Ви зможете відновити його пізніше.',
        'force_delete_confirmation' => 'Ця дія НАЗАВЖДИ видалить екземпляр із системи та Evolution API. Цю дію неможливо скасувати.',
        'refresh' => 'Оновити',
