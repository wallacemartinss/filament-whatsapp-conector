...
return [
    ...
    'actions' => [
        ...
        'delete' => 'Удалить',
        'delete_confirmation' => 'Это действие переместит экземпляр в корзину. Вы сможете восстановить его позже.',
        'force_delete_confirmation' => 'Это действие НАВСЕГДА удалит экземпляр из системы и Evolution API. Это действие нельзя отменить.',
        'refresh' => 'Обновить',
